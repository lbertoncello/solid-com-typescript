 ...
 * 
 * SUBTIPOS DEVEM PODER SUBSTITUIR O TIPO BASE SEM ALTERAR O FUNCIONAMENTO.
 *
 * Mais simples: Subtipos precisam ser substituíveis substituir por seus tipos base.
